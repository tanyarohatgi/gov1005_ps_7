...
y <- graph1 %>%
  mutate(region = str_replace_all(region, c("ME" = "Northeast", "NJ" = "Northeast", "NY" = "Northeast", "PA" = "Northeast", "IA" = "Midwest", "IL" = "Midwest", "KS" = "Midwest", "MI" = "Midwest", "MN" = "Midwest", "NE" = "Midwest", "OH"= "Midwest", "WI" = "Midwest", "FL" = "South", "GA" = "South", "KY" = "South", "NC" = "South", "TX" = "South", "VA" = "South", "WV" = "South", "AZ" = "West", "CA" = "West", "CO" = "West", "NM" = "West", "UT" = "West", "WA" = "West")))
